...
function WalletCard() {
  return (
    <div className="relative h-[199px] w-full overflow-hidden rounded-[22px] bg-gold sm:w-[408px]">
      <Image
      ...
      <div className="relative flex h-full flex-col justify-between p-[26px]">
        ...
        <div className="flex gap-2">
          <button className="flex flex-1 items-center justify-center gap-1 rounded-[81px] bg-ink/[0.13] py-2.5 font-display text-[16px] font-medium text-black">
            <PlusIcon className="h-4 w-4" />
            Fund Wallet
          </button>
          <button className="flex flex-1 items-center justify-center gap-1 rounded-[81px] border border-black/[0.26] bg-ink/90 py-2.5 font-display text-[16px] font-medium text-[#d3d2d0]">
  ...
  return (
    <div className="relative h-[195px] flex-1 overflow-hidden rounded-[16px] border border-black/5 bg-white sm:w-[134px] sm:flex-none">
      ...
      <div className="relative flex h-full flex-col items-center gap-[11px] p-[17px]">
        <img
          src={stat.icon}
          className={`flex h-[56px] w-[56px] items-center justify-center rounded-full border-[3px] bg-gradient-to-b ${stat.grad}`}
