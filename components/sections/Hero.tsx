    ...
    >
      ...
      <div className="relative z-20">
        ...
        <Image
          ...
          height={906}
          priority
          className="pointer-events-none absolute left-1/2 -translate-x-1/3 top-[219px] h-[906px] w-[1153px] object-contain"
        />

        <Header />

        {/* hero copy */}
        <div className="absolute left-1/2 -translate-x-1/2 top-[153px] z-20 flex w-[1050px] flex-col gap-[37px]">
        ...
        <XpBadge className="absolute left-[390px] top-[635px] z-20 -rotate-[10deg]" />
        <img src='/images/prizeWon.svg' className="absolute left-[216px] top-[676px] z-20"/>
        ...
        <img src='/images/liveBattle.svg'  className="absolute right-[5%] top-[300px] z-10"/>
        {/* <LeaderboardCard className="absolute left-[1028px] top-[628px] z-20" /> */}
        <img src='/images/leaderboard.svg' className="absolute right-[5%] top-[628px] z-20" />
      </div>
